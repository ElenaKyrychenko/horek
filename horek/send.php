...
$error="no"; //флаг наличия ошибки
		...
		$posSub = addslashes($_POST['posSub']);
		$posSub = htmlspecialchars($posSub);
		$posSub = stripslashes($posSub);
		$posSub = trim($posSub);
...
//Проверка правильность темы
if(!$posSub || strlen($posSub)>30 || strlen($posSub)<5) {
$log.="<li>Неправильно заполнено поле \"Тема\" (5-30 символов)!</li>"; $error="yes"; }
...
$mes = "Человек по имени $posName отправил Вам сообщение из формы обратной связи Вашего сайта: ".$_SERVER['HTTP_REFERER']." \n\n$posText";
